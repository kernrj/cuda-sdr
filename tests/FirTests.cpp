...
TEST(WhenSomething, ItDoesSomething) {
  ...
  cuComplex cpuData2[dataCount - sizeof(cpuData1) / sizeof(cpuData1[0])] = {
      make_cuComplex(0.7f, 0.8f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      ...
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f)};
  ...
  ensureMinCapacityAlignedCuda(&outputBuffers[0], fir.getAlignedOutputDataSize(0), 32 * sizeof(cuComplex), nullptr);
  ...
  cudaMemcpy(
      ...
      expectedOutputCount * sizeof(cuComplex),
      cudaMemcpyDeviceToHost);

  cuComplex expectedValues[expectedOutputCount] = {
      make_cuComplex(0.35f, 0.5f), make_cuComplex(0.95f, 1.1f), make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
      make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f),  make_cuComplex(0.0f, 0.0f), make_cuComplex(0.0f, 0.0f),
